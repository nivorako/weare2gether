...
const Header = () => {
    ...
    const toolbarBGColor = useSelector((state) => state.toolbar.backgroundColor);
                    ...
                    <Headroom>
                        ...
                        >
                            ...
                            (   <HeaderNav >
                                    <HeaderLink to="/Blog">
                                        <HeaderNavItem>
                                            <Button variant="text" sx={{color:toolbarColor}}>BLOG</Button>
                                        </HeaderNavItem>
                                    </HeaderLink>
                                    <HeaderLink to="/Connexion">
                                        <HeaderNavItem>
                                            <Button variant="text" sx={{color:toolbarColor}}>CONNEXION</Button>
                                        </HeaderNavItem>
                                    </HeaderLink>
                                    <HeaderLink >
                                        <HeaderNavItem>
                                    ...
                                    <HeaderLink >
                                        <HeaderNavItem>
                                            <img src={shopBsktColor} alt="shopping basket"/>
                                        </HeaderNavItem>
                                    </HeaderLink>
                                </HeaderNav>)
                            }
